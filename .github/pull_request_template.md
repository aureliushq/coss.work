...
- [ ] Position ids come from [positions.json](https://github.com/aureliushq/coss.work/blob/main/app/data/positions.json), tech ids from [tech.json](https://github.com/aureliushq/coss.work/blob/main/app/data/tech.json), and office ids from [locations.json](https://github.com/aureliushq/coss.work/blob/main/app/data/locations.json) (or `remote`)
- [ ] Each level and position pair is listed at most once, so every job gets its own page
