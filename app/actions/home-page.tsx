	...
	return () => (
		...
		>
			...
			>
				...
				>
					Navigate to this project folder using your preferred AI-powered tool, and try
					copying any of these prompts into the agent chat:
				</p>
	...
	return () => {
		...
		return (
			...
			>
				...
				<span mix={css({ fontSize: '14px', lineHeight: 1.5, whiteSpace: 'nowrap' })}>
					{label}
				</span>
			</a>
		)
