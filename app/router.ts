...
import jobController from './actions/job/controller.tsx'
...
import titleController from './actions/title/controller.tsx'
...
router.map(routes.job, jobController)
...
router.map(routes.title, titleController)
